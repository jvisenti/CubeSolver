...
void main()
{
    ...
    if (lightInfo.enabled == true)
    {
        ...
        scatteredLight += lightInfo.ambient * u_Material.ambient * attenuation + lightInfo.diffuseColor * u_Material.diffuse * diffuse * attenuation;
        reflectedLight += lightInfo.diffuseColor * u_Material.specular * specular * attenuation;
    }
